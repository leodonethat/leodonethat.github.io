...
A good place to start is the [readme of the project](https://github.com/ledgerwatch/erigon).
...
Which verifies the download and gave me more details of the errors and another command to run the download with   in place
...
./build/bin/erigon --downloader.verify --datadir mainnet
 ...
 Werdly, that one ran for a few hours and gave me another strange error but I ran it again and it managed to finish this time 🥳
